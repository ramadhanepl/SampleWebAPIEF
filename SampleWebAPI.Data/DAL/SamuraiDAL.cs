...
namespace SampleWebAPI.Data.DAL
{
    public class SamuraiDAL : ISamurai
    {
        ...
        public async Task<IEnumerable<Samurai>> GetSamuraiWithQuote()
        {
            var samurais = await _context.Samurais.Include(s => s.Quotes).OrderBy(s => s.Name).ToListAsync();
            return samurais;
        }

        public async Task<IEnumerable<Samurai>> GetSamuraiWithSwordElement()
        {
            // samurai > sword
           var samurais = await _context.Samurais.Include(s => s.Swords).ThenInclude(e => e.Elements).OrderBy(s => s.Name).ToListAsync();
